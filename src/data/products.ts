...
let settings: SiteSettings = {
  ...
  whatsappNumber: '',
  heroTitleAr: 'مجوهرات سواروفسكي الفاخرة',
  heroTitleEn: 'Luxury Swarovski Jewelry',
  heroSubtitleAr: 'اكتشفي مجموعتنا الحصرية من أجمل مجوهرات سواروفسكي',
  heroSubtitleEn: 'Discover our exclusive collection of the finest Swarovski jewelry',
  adminUser: 'admin',
